...
- [ ] Objective is written in one paragraph.
- [ ] Users and main workflows are named.
- [ ] Non-goals are explicit.
- [ ] Stack packs are selected.
- [ ] UI member is selected or deferred with a reason.
- [ ] Data sources and owners are listed.
